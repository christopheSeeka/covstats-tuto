...
(function () {
  ...
  function Ya(p, m, D) {
    "millisecond" === D
      ? p.setMilliseconds(p.getMilliseconds() + 1 * m)
      : "second" === D
      ? p.setSeconds(p.getSeconds() + 1 * m)
      : "minute" === D
      ? p.setMinutes(p.getMinutes() + 1 * m)
      : "hour" === D
      ? p.setHours(p.getHours() + 1 * m)
      : "day" === D
      ? p.setDate(p.getDate() + 1 * m)
      : "week" === D
      ? p.setDate(p.getDate() + 7 * m)
      : "month" === D
      ? p.setMonth(p.getMonth() + 1 * m)
      : "year" === D && p.setFullYear(p.getFullYear() + 1 * m);
    return p;
  }
  function $(p, m) {
    var D = !1;
  ...
  function Ta(p, m, D) {
    if (p && m && D) {
      ...
      if ("undefined" !== typeof Blob && new Blob()) {
        for (
          var H = p.replace(/^data:[a-z\/]*;base64,/, ""),
            H = atob(H),
            y = new ArrayBuffer(H.length),
            y = new Uint8Array(y),
            w = 0;
          w < H.length;
          w++
        ...
        try {
          ...
          (F.dataset.downloadurl = [r, F.download, F.href].join(":")),
            (F.href = window.URL.createObjectURL(m));
        }
      }
      if (!v)
        try {
  ...
  function gb(p) {
    if (U.fSDec)
      p[ja("`eeDwdouMhrudods")](ja("e`u`@ohl`uhnoHuds`uhnoDoe"), function () {
        U._fTWm && U._fTWm(p);
      });
  }
  function Za(p, m, D) {
  ...
  function hb(p) {
    if (!ib) {
      ...
      "undefined" === typeof ra.Chart.creditHref
        ? ((p.creditHref = ja("iuuqr;..b`ow`rkr/bnl.")),
          (p.creditText = ja("B`ow`rKR/bnl")))
        : ((m = p.updateOption("creditText")),
          (D = p.updateOption("creditHref")));
      if (p.creditHref && p.creditText) {
        p._creditLink ||
          ((p._creditLink = document.createElement("a")),
          p._creditLink.setAttribute("class", "canvasjs-chart-credit"),
          p._creditLink.setAttribute("title", "JavaScript Charts"),
  ...
  function ua(p, m, D) {
    m.getAttribute("state") ||
      ((m.style.backgroundColor = p.toolbar.backgroundColor),
    ...
    m.getAttribute("state") !== D &&
      (m.setAttribute("state", D),
      ...
      m.setAttribute("title", p._cultureInfo[D + "Text"]),
      (m.innerHTML =
        "<img style='height:95%; pointer-events: none;' src='" +
        jb[D].image +
        "' alt='" +
        p._cultureInfo[D + "Text"] +
        "' />"));
  }
  function Qa() {
    for (var p = null, m = 0; m < arguments.length; m++)
  ...
  function V(p, m, D, r, w) {
    ...
    p = {};
    this.theme && v(m) && v(r)
      ? (p = v(ya[this.theme]) ? ya.light1 : ya[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[m] &&
        (null === r
          ? (p = this.parent.themeOptions[m])
          : 0 < this.parent.themeOptions[m].length &&
            ((r = Math.min(this.parent.themeOptions[m].length - 1, r)),
            (p = this.parent.themeOptions[m][r])));
    this.themeOptions = p;
  ...
  function Aa(p, m) {
    ...
    if (v(this.options.margin) && p.options.subtitles)
      for (var r = p.options.subtitles, za = 0; za < r.length; za++)
        if (
          ((v(r[za].horizontalAlign) && "center" === this.horizontalAlign) ||
            r[za].horizontalAlign === this.horizontalAlign) &&
          ((v(r[za].verticalAlign) && "top" === this.verticalAlign) ||
  ...
  (function () {
    ...
    delete ra[U.fSDec([178, 215, 208, 225, 227])][
      U.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])
    ];
    U.pro = {
      sCH:
        ra[U.fSDec([178, 215, 208, 225, 227])][
          U.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])
        ],
    };
    U._fTWm = function (p) {
  ...
  var $a = {},
    ...
    lb = function (p, m, r) {
      ...
      return Math.max(
        "theme4" === this.theme ? 0 : 300 <= m ? 12 : 10,
        Math.round(m * (p / 400))
      );
    },
    Ca = (function () {
        ...
        return (L = E.replace(p, function (g) {
          switch (g) {
            ...
            case "K":
              return S
                ? "UTC"
                : (String(y).match(F) || [""]).pop().replace(H, "");
            case "z":
        ...
        if (((m = y[Q]), "." === m && 0 > E)) E = Q;
          ...
          if ("%" === m) H *= 100;
            ...
            ("E" !== m[0] && "e" !== m[0]) ||
              ...
              (O = !0);
          0 > E
            ? (L.push(m), "#" === m || "0" === m ? I++ : "," === m && S++)
            : (R.push(m), ("#" !== m && "0" !== m) || N++);
        }
      O &&
        ((m = Math.floor(p)),
        (y = -Math.floor(Math.log(p) / Math.LN10 + 1)),
        (U = 0 === p ? 0 : 0 === m ? -(I + y) : String(m).length - I),
        (H /= Math.pow(10, U)));
      0 > E && (E = Q);
      H = (p * H).toFixed(N);
      m = H.split(".");
        ...
        if (((m = L.pop()), "#" === m || "0" === m))
          if ((E++, E === I)) {
            ...
            for (; 0 < M.length; )
              (r = M.pop() + r),
                O++,
                0 === O % y && Q === S && 0 < M.length && (r = F + r);
          } else
            0 < H.length
              ? ((r = H.pop() + r), N++, O++)
              : "0" === m && ((r = "0" + r), N++, O++),
              0 === O % y && Q === S && 0 < H.length && (r = F + r);
        else
          ("E" !== m[0] && "e" !== m[0]) ||
          "0" !== m[m.length - 1] ||
          !/[eE][+-]*[0]+/.test(m)
            ? "," === m
              ? (Q++, (y = O), (O = 0), 0 < H.length && (r = F + r))
              : (r =
                  1 < m.length &&
                  (('"' === m[0] && '"' === m[m.length - 1]) ||
                    ("'" === m[0] && "'" === m[m.length - 1]))
    ...
    Ra = function (p) {
      ...
      p.offsetX || 0 === p.offsetX
        ? ((m = p.offsetX), (r = p.offsetY))
        : p.layerX || 0 == p.layerX
        ? ((m = p.layerX), (r = p.layerY))
        : ((m = p.pageX - p.target.offsetLeft),
          (r = p.pageY - p.target.offsetTop));
      return { x: m, y: r };
    },
    bb = !0,
    ...
    ea = function (p, m, r, v, w, F, H, y, E, L, R, N, O) {
      ...
      0 < H &&
        ...
        (p.strokeStyle = y),
        p.moveTo(m, r),
        p.rect(m - O, r - O, v - m + 2 * O, w - r + 2 * O),
        p.stroke());
      p.restore();
      !0 === E &&
        (p.save(),
        ...
        p.lineTo(v, r),
        p.closePath(),
        (H = p.createLinearGradient((v + m) / 2, r + I, (v + m) / 2, r)),
        H.addColorStop(0, F),
      ...
      !0 === L &&
        ...
        p.lineTo(v, w),
        p.closePath(),
        (H = p.createLinearGradient((v + m) / 2, w - I, (v + m) / 2, w)),
        H.addColorStop(0, F),
        H.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (p.fillStyle = H),
        p.fill(),
      ...
      !0 === R &&
        ...
        p.lineTo(m, w),
        p.closePath(),
        (H = p.createLinearGradient(m + I, (w + r) / 2, m, (w + r) / 2)),
        H.addColorStop(0, F),
      ...
      !0 === N &&
        ...
        p.lineTo(v - I, w - I),
        p.lineTo(v, w),
        (H = p.createLinearGradient(v - I, (w + r) / 2, v, (w + r) / 2)),
        H.addColorStop(0, F),
        H.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (p.fillStyle = H),
        H.addColorStop(0, F),
    ...
    ja = function (p) {
      for (var m = "", r = 0; r < p.length; r++)
        m += String.fromCharCode(
          Math.ceil(p.length / 57 / 5) ^ p.charCodeAt(r)
        );
      return m;
    },
    db =
  ...
  V.prototype.setOptions = function (p, m) {
    if (ra[this._defaultsKey]) {
      ...
      for (v in r)
        "publicProperties" !== v &&
          r.hasOwnProperty(v) &&
          (this[v] = p && v in p ? p[v] : m && v in m ? m[v] : r[v]);
  ...
  V.prototype.get = function (p) {
    ...
    if (
      m.hasOwnProperty(p) ||
      (m.publicProperties && m.publicProperties.hasOwnProperty(p))
    )
      return this[p];
    window.console &&
      window.console.log(
  ...
  V.prototype.addTo = function (p, m, r, v) {
    ...
    w.hasOwnProperty(p) ||
    (w.publicProperties &&
      w.publicProperties.hasOwnProperty(p) &&
      "readWrite" === w.publicProperties[p])
      ? (this.options._isPlaceholder && this.createUserOptions(),
        "undefined" === typeof this.options[p] && (this.options[p] = []),
        (p = this.options[p]),
        (r = "undefined" === typeof r || null === r ? p.length : r),
        p.splice(r, 0, m),
        v && (this.chart || this).render())
      : window.console &&
        (w.publicProperties &&
        w.publicProperties.hasOwnProperty(p) &&
        "readOnly" === w.publicProperties[p]
          ? window.console.log('Property "' + p + '" is read-only.')
          : window.console.log(
              'Property "' + p + "\" doesn't exist. Please check for typo."
            ));
  ...
  V.prototype.updateOption = function (p) {
    ...
    var m = ra[this._defaultsKey],
      ...
      F = this._index;
    this.theme && v(E) && v(F)
      ? (r = v(ya[this.theme]) ? ya.light1 : ya[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        ...
        (null === F
          ...
          : 0 < this.parent.themeOptions[E].length &&
            ((r = Math.min(this.parent.themeOptions[E].length - 1, F)),
            (r = this.parent.themeOptions[E][r])));
    this.themeOptions = r;
    p in m &&
      (w = p in this.options ? this.options[p] : r && p in r ? r[p] : m[p]);
  ...
  V.prototype.addEventListener = function (p, m, r) {
    p &&
      ...
      this._eventListeners[p].push({ context: r || this, eventHandler: m }));
  };
  ...
  Ga.prototype.registerSpace = function (p, m) {
    "top" === p
      ...
      : "right" === p && (this._rightOccupied += m.width);
  };
  ...
  ka.prototype._initialize = function () {
    v(this.padding) || "object" !== typeof this.padding
      ? (this.topPadding = this.rightPadding = this.bottomPadding = this.leftPadding =
          Number(this.padding) | 0)
      : ((this.topPadding = v(this.padding.top)
          ? 0
          : Number(this.padding.top) | 0),
        (this.rightPadding = v(this.padding.right)
          ? 0
          : Number(this.padding.right) | 0),
        (this.bottomPadding = v(this.padding.bottom)
          ? 0
          : Number(this.padding.bottom) | 0),
        (this.leftPadding = v(this.padding.left)
          ? 0
  ...
  ka.prototype._getLineWithWidth = function (p, m, r) {
    ...
    r > m &&
      1 < H.length &&
      ((H = H.substr(0, H.length - 1)), (r = this.ctx.measureText(H).width));
    m = !0;
    ...
    if (0 === this.frontSize) w = v = 0;
      ...
      for (; 0 < p.length; ) {
        ...
        var y = w,
          ...
          v = v + H.height,
          p = Ia(p.slice(H.text.length, p.length));
  ...
  Aa.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              m.width - 4 - H * ("center" === this.horizontalAlign ? 2 : 1)),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign || "right" === this.horizontalAlign
            ...
            : "center" === this.horizontalAlign &&
              ...
              (F = 0.5 * m.height - 4)));
      var L;
      v(this.padding) || "number" !== typeof this.padding
        ? v(this.padding) ||
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((w = m.y2 - 2 - L.height), (I = "bottom")),
          "left" === this.horizontalAlign
            ? (r = m.x1 + 2)
            : "center" === this.horizontalAlign
            ? (r = m.x1 + m.width / 2 - L.width / 2)
            : "right" === this.horizontalAlign && (r = m.x2 - 2 - L.width - H),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((r = m.x1 + 2),
              (w = m.y2 - 2 - (this.maxWidth / 2 - L.width / 2)),
              (E = -90),
              (I = "left"),
              (this.width = L.height),
              (this.height = L.width))
            : "right" === this.horizontalAlign
            ? ((r = m.x2 - 2),
              (w = m.y1 + 2 + (this.maxWidth / 2 - L.width / 2)),
              (E = 90),
              (I = "right"),
              (this.width = L.height),
              (this.height = L.width))
            : "center" === this.horizontalAlign &&
              ((w = p.y1 + (p.height / 2 - L.height / 2)),
  ...
  Na.Chart = (function () {
      ...
      for (var b = [], c, e = 0; e < a.length; e++)
        if (0 == e) b.push(a[0]);
          ...
          c =
            (Math.abs(
              (a[h].x - a[g].x) /
                (0 === a[h].x - a[k].x ? 0.01 : a[h].x - a[k].x)
            ) *
              (d - 1)) /
              2 +
            1;
          ...
          c = (a[h].y - a[g].y) / c;
          b[b.length] =
            (a[k].x > a[g].x && 0 < t) || (a[k].x < a[g].x && 0 > t)
              ? { x: a[k].x + t / 3, y: a[k].y + c / 3 }
              : { x: a[k].x, y: a[k].y + c / 9 };
          k = e;
          g = 0 === k ? 0 : k - 1;
          h = k === a.length - 1 ? k : k + 1;
          c =
            (Math.abs(
              (a[h].x - a[g].x) /
                (0 === a[k].x - a[g].x ? 0.01 : a[k].x - a[g].x)
            ) *
              (d - 1)) /
              2 +
            1;
    ...
    function L(a, d, b, c, e, g) {
      ...
      this.lineThickness = v(b.lineThickness)
        ? g.lineThickness
        : this.lineThickness;
        ...
        for (var b = 0; b < this.options.data.length; b++)
          if (
            ...
            !this.options.data[b].type ||
              0 <= m._supportedChartTypes.indexOf(this.options.data[b].type))
          ) {
            var c = new H(
              this,
              this.options.data[b],
    ...
    m.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          var g = this.plotInfo.plotTypes[d], h = 0;
          h < g.plotUnits.length;
          h++
        ) {
          var k = g.plotUnits[h],
            t = null;
          k.targetCanvas = null;
          this.animatedRender &&
            ((k.targetCanvas = ta(this.width, this.height)),
          ...
          "line" === k.type
            ? (t = this.renderLine(k))
            : "stepLine" === k.type
            ? (t = this.renderStepLine(k))
            : "spline" === k.type
            ? (t = this.renderSpline(k))
            : "column" === k.type
            ? (t = this.renderColumn(k))
            : "bar" === k.type
            ? (t = this.renderBar(k))
            : "area" === k.type
            ? (t = this.renderArea(k))
            : "stepArea" === k.type
            ? (t = this.renderStepArea(k))
            : "splineArea" === k.type
            ? (t = this.renderSplineArea(k))
            : "stackedColumn" === k.type
            ? (t = this.renderStackedColumn(k))
            : "stackedColumn100" === k.type
            ? (t = this.renderStackedColumn100(k))
            : "stackedBar" === k.type
            ? (t = this.renderStackedBar(k))
            : "stackedBar100" === k.type
            ? (t = this.renderStackedBar100(k))
            : "stackedArea" === k.type
            ? (t = this.renderStackedArea(k))
            : "stackedArea100" === k.type
            ? (t = this.renderStackedArea100(k))
            : "bubble" === k.type
            ? (t = t = this.renderBubble(k))
            : "scatter" === k.type
            ? (t = this.renderScatter(k))
            : "pie" === k.type
            ? this.renderPie(k)
            : "doughnut" === k.type
            ? this.renderPie(k)
            : "funnel" === k.type
            ? (t = this.renderFunnel(k))
            : "pyramid" === k.type
            ? (t = this.renderFunnel(k))
            : "candlestick" === k.type
            ? (t = this.renderCandlestick(k))
            : "ohlc" === k.type
            ? (t = this.renderCandlestick(k))
            : "rangeColumn" === k.type
            ? (t = this.renderRangeColumn(k))
            : "error" === k.type
            ? (t = this.renderError(k))
            : "rangeBar" === k.type
            ? (t = this.renderRangeBar(k))
            : "rangeArea" === k.type
            ? (t = this.renderRangeArea(k))
            : "rangeSplineArea" === k.type
            ? (t = this.renderRangeSplineArea(k))
            : "waterfall" === k.type
            ? (t = this.renderWaterfall(k))
            : "boxAndWhisker" === k.type && (t = this.renderBoxAndWhisker(k));
          for (var l = 0; l < k.dataSeriesIndexes.length; l++)
            this._dataInRenderedOrder.push(this.data[k.dataSeriesIndexes[l]]);
          this.animatedRender &&
            ((k.targetCanvasCtx.miterLimit = e), t && b.push(t));
        }
      ...
      if (0 < b.length)
          ...
          u._animator.animate(
            ...
            function (a) {
              ...
              u.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(u.width * W),
                Math.floor(u.height * W),
                0,
                0,
                u.width,
                u.height
              ...
              for (var e = 0; e < b.length; e++)
                (t = b[e]),
                  1 > a && "undefined" !== typeof t.startTimePercent
                    ? a >= t.startTimePercent &&
                      t.animationCallback(
                        t.easingFunction(
                          ...
                          0,
                          1,
                          1 - t.startTimePercent
                        ),
                        t
                      )
                    : t.animationCallback(t.easingFunction(a, 0, 1, 1), t);
            ...
            function () {
              ...
              for (var a = 0; a < u.plotInfo.plotTypes.length; a++)
                for (
                  var e = u.plotInfo.plotTypes[a], d = 0;
        ...
        if (u._breaksCanvas)
          ...
          else for (l = 0; l < u._axes.length; l++) u._axes[l].createMask();
      ...
      Ja &&
        ...
        setTimeout(function () {
          ...
          a &&
            (Oa(a, u.width, u.height),
            a.getContext("2d").drawImage(u._eventManager.ghostCanvas, 0, 0));
        }, 2e3));
      this._breaksCanvas &&
        (delete this._breaksCanvas, delete this._breaksCanvasCtx);
      for (l = 0; l < this._axes.length; l++)
        this._axes[l].maskCanvas &&
          (delete this._axes[l].maskCanvas, delete this._axes[l].maskCtx);
    };
    ...
    m.prototype.categoriseDataSeries = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          b = this.plotInfo.plotTypes[d], h = a = 0;
          ...
          if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
            var n = a.axisX.sessionVariables.newViewportMinimum
              ...
              f = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (k.dataPoints[t].x && k.dataPoints[t].x.getTime) ||
            "dateTime" === k.xValueType
          )
            g = !0;
          for (t = 0; t < k.dataPoints.length; t++) {
            "undefined" === typeof k.dataPoints[t].x &&
              (k.dataPoints[t].x = t + (a.axisX.logarithmic ? 1 : 0));
            k.dataPoints[t].x.getTime
              ? ((g = !0), (c = k.dataPoints[t].x.getTime()))
              : (c = k.dataPoints[t].x);
            e = k.dataPoints[t].y;
            c < b.min && (b.min = c);
            c > b.max && (b.max = c);
            ...
            if (0 < t) {
              if (a.axisX.logarithmic) {
                ...
                (A = c - k.dataPoints[t - 1].x),
                  0 > A && (A *= -1),
                  b.minDiff > A && 0 !== A && (b.minDiff = A);
              null !== e &&
                null !== k.dataPoints[t - 1].y &&
                (a.axisY.logarithmic
                  ? ((A = e / k.dataPoints[t - 1].y),
                    1 > A && (A = 1 / A),
            ...
            if (c < n && !l) null !== e && (q = c);
              ...
              k.dataPoints[t].label &&
                (a.axisX.labels[c] = k.dataPoints[t].label);
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          a.axisY.scaleBreaks &&
            ...
            (d.dataPointYPositiveSums
              ...
              : ((d.dataPointYPositiveSums = h),
                (d.dataPointYNegativeSums = k)));
        ...
        for (n in h)
          h.hasOwnProperty(n) &&
            !isNaN(n) &&
            ((a = h[n]),
            a < d.min && (d.min = Math.min(a, t)),
            a > d.max && (d.max = a),
            n < b.viewPortMin ||
              n > b.viewPortMax ||
              (a < d.viewPortMin && (d.viewPortMin = Math.min(a, t)),
        ...
        for (n in k)
          k.hasOwnProperty(n) &&
            ...
            ((a = k[n]),
            a < d.min && (d.min = a),
            a > d.max && (d.max = Math.max(a, l)),
            n < b.viewPortMin ||
              n > b.viewPortMax ||
              (a < d.viewPortMin && (d.viewPortMin = a),
              a > d.viewPortMax && (d.viewPortMax = Math.max(a, l))));
      }
    };
    m.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement)
            var p = a.axisX.sessionVariables.newViewportMinimum
              ...
              r = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (u.dataPoints[q].x && u.dataPoints[q].x.getTime) ||
            "dateTime" === u.xValueType
          )
            g = !0;
          for (q = 0; q < u.dataPoints.length; q++) {
            "undefined" === typeof u.dataPoints[q].x &&
              (u.dataPoints[q].x = q + (a.axisX.logarithmic ? 1 : 0));
            u.dataPoints[q].x.getTime
              ? ((g = !0), (c = u.dataPoints[q].x.getTime()))
              : (c = u.dataPoints[q].x);
            ...
            if (0 < q) {
              if (a.axisX.logarithmic) {
                ...
                (s = c - u.dataPoints[q - 1].x),
                  0 > s && (s *= -1),
                  b.minDiff > s && 0 !== s && (b.minDiff = s);
              v(e) ||
                null === u.dataPoints[q - 1].y ||
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((s = e / u.dataPoints[q - 1].y),
                    1 > s && (s = 1 / s),
            ...
            if (c < p && !n) null !== e && (A = c);
              ...
              u.dataPoints[q].label &&
                (a.axisX.labels[c] = u.dataPoints[q].label);
              c < b.viewPortMin && (b.viewPortMin = c);
              c > b.viewPortMax && (b.viewPortMax = c);
              null === e
        ...
        a.axisY.logarithmic
          ? ((d.max = v(d.viewPortMax)
              ? 99 * Math.pow(a.axisY.logarithmBase, -0.05)
              : Math.max(
                  d.viewPortMax,
                  99 * Math.pow(a.axisY.logarithmBase, -0.05)
                )),
            (d.min = v(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
          : h && !k
          ? ((d.max = v(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)),
            (d.min = v(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
          : h && k
          ? ((d.max = v(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)),
            (d.min = v(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)))
          : !h &&
            k &&
            ((d.max = v(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)),
            (d.min = v(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
        d.viewPortMin = d.min;
        d.viewPortMax = d.max;
        a.dataPointYSums = t;
          ...
          if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
            var r = a.axisX.sessionVariables.newViewportMinimum
              ...
              s = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (l.dataPoints[u].x && l.dataPoints[u].x.getTime) ||
            "dateTime" === l.xValueType
          )
            k = !0;
          for (u = 0; u < l.dataPoints.length; u++) {
            "undefined" === typeof l.dataPoints[u].x &&
              (l.dataPoints[u].x = u + (a.axisX.logarithmic ? 1 : 0));
            l.dataPoints[u].x.getTime
              ? ((k = !0), (c = l.dataPoints[u].x.getTime()))
              : (c = l.dataPoints[u].x);
            ...
            0 < u &&
              ...
              e &&
                null !== e[0] &&
                l.dataPoints[u - 1].y &&
                null !== l.dataPoints[u - 1].y[0] &&
                (a.axisY.logarithmic
                  ? ((A = e[0] / l.dataPoints[u - 1].y[0]),
                    1 > A && (A = 1 / A),
                    d.minDiff > A && 1 !== A && (d.minDiff = A))
                  : ((A = e[0] - l.dataPoints[u - 1].y[0]),
                    0 > A && (A *= -1),
            ...
            if (!(c < r) || q) {
              ...
              l.dataPoints[u].label &&
                (a.axisX.labels[c] = l.dataPoints[u].label);
              c < b.viewPortMin && (b.viewPortMin = c);
              c > b.viewPortMax && (b.viewPortMax = c);
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            g = !0;
          for (t = 0; t < k.dataPoints.length; t++)
            "undefined" !== typeof k.dataPoints[t].isCumulativeSum &&
            !0 === k.dataPoints[t].isCumulativeSum
              ? ((k.dataPointEOs[t].cumulativeSumYStartValue = 0),
                (k.dataPointEOs[t].cumulativeSum =
                  0 === t ? 0 : k.dataPointEOs[t - 1].cumulativeSum),
                (k.dataPoints[t].y =
                  0 === t ? 0 : k.dataPointEOs[t - 1].cumulativeSum))
              : "undefined" !== typeof k.dataPoints[t].isIntermediateSum &&
                !0 === k.dataPoints[t].isIntermediateSum
              ? ((k.dataPointEOs[t].cumulativeSumYStartValue = q),
                (k.dataPointEOs[t].cumulativeSum =
                  0 === t ? 0 : k.dataPointEOs[t - 1].cumulativeSum),
                (k.dataPoints[t].y = 0 === t ? 0 : c),
                (q = 0 === t ? 0 : k.dataPointEOs[t - 1].cumulativeSum),
                (c = 0))
              : ((e =
                  "number" !== typeof k.dataPoints[t].y
                    ? 0
                    : k.dataPoints[t].y),
                (k.dataPointEOs[t].cumulativeSumYStartValue =
                  0 === t ? 0 : k.dataPointEOs[t - 1].cumulativeSum),
                (k.dataPointEOs[t].cumulativeSum =
                  0 === t ? e : k.dataPointEOs[t - 1].cumulativeSum + e),
                (c += e));
          for (t = 0; t < k.dataPoints.length; t++)
            if (
              ("undefined" === typeof k.dataPoints[t].x &&
              ...
              c < b.min && (b.min = c),
              c > b.max && (b.max = c),
              k.dataPointEOs[t].cumulativeSum < d.min &&
                (d.min = k.dataPointEOs[t].cumulativeSum),
              k.dataPointEOs[t].cumulativeSum > d.max &&
                (d.max = k.dataPointEOs[t].cumulativeSum),
              0 < t &&
                (a.axisX.logarithmic
                  ? ((q = c / k.dataPoints[t - 1].x),
                    1 > q && (q = 1 / q),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        k.dataPointEOs[t].cumulativeSum /
                        k.dataPointEOs[t - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              c > b.viewPortMax && (b.viewPortMax = c);
              0 < t &&
                (k.dataPointEOs[t - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = k.dataPointEOs[t - 1].cumulativeSum),
                k.dataPointEOs[t - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = k.dataPointEOs[t - 1].cumulativeSum));
              k.dataPointEOs[t].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = k.dataPointEOs[t].cumulativeSum);
              k.dataPointEOs[t].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = k.dataPointEOs[t].cumulativeSum);
            }
          k.axisX.valueType = k.xValueType = g ? "dateTime" : "number";
        }
    };
    m.prototype.calculateAutoBreaks = function () {
          ...
          if (c || b)
            for (
              ...
              if (!(4 > p.dataPoints.length))
                for (t = 0; t < p.dataPoints.length; t++)
                  if (
                    (c &&
                      ((q =
                        ((k + 1 - l) *
                        ...
                        100),
                      (g = p.dataPoints[t].x.getTime
                        ? p.dataPoints[t].x.getTime()
                        : p.dataPoints[t].x),
                      (q = Math.floor((g - l) / q)),
                      g < f[q].min && (f[q].min = g),
                      g > f[q].max && (f[q].max = g)),
                    ...
                    if (
                      (g =
                        "waterfall" === a.type
                          ? p.dataPointEOs[t].cumulativeSum
                          : p.dataPoints[t].y) &&
                      g.length
                    )
                      for (var m = 0; m < g.length; m++)
                        (q = Math.floor((g[m] - h) / r)),
                          g[m] < d[q].min && (d[q].min = g[m]),
                          g[m] > d[q].max && (d[q].max = g[m]);
                    else
                      v(g) ||
                        ((q = Math.floor((g - h) / r)),
                        g < d[q].min && (d[q].min = g),
      ...
      if (g) {
        for (h = 0; h < this.plotInfo.plotTypes.length; h++)
          for (
            g = this.plotInfo.plotTypes[h], k = 0;
        ...
        for (h = 0; h < this._axes.length; h++)
          if (this._axes[h].dataInfo._dataRanges) {
            ...
            if (this._axes[h].scaleBreaks.customBreaks)
              for (
                k = 0;
                k < this._axes[h].scaleBreaks.customBreaks.length;
                k++
              )
                for (c = 0; c < g.length; c++)
                  if (
                    (this._axes[h].scaleBreaks.customBreaks[k].startValue <=
                      g[c].start &&
                      g[c].start <=
                        this._axes[h].scaleBreaks.customBreaks[k].endValue) ||
                    (this._axes[h].scaleBreaks.customBreaks[k].startValue <=
                      g[c].start &&
                      g[c].start <=
                        this._axes[h].scaleBreaks.customBreaks[k].endValue) ||
      ...
      if (a.changedTouches && this.interactivityEnabled) {
        ...
        if (!(b && 1 < b.length)) {
          ...
          try {
            ...
            if (
              (1 < Math.abs(h) && this._lastTouchData.scroll) ||
              (5 < Math.abs(h) && 250 > g)
            )
      ...
      for (h = 0; h < l.length; h++) {
        ...
        if (isFinite(q.dataInfo.minDiff))
          if (
            ...
            t.push(q), u.push({ val1: n, val2: f }), (k = !0);
          else if (!e) {
            k = !1;
            break;
          }
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var l = this._indexLabels[a],
          ...
          q,
          n,
          k = na("indexLabelFontColor", l.dataPoint, l.dataSeries),
        ...
        var h = na("indexLabelFontWeight", l.dataPoint, l.dataSeries),
          ...
          m = v(l.dataPoint.indexLabelLineThickness)
            ? v(l.dataSeries.options.indexLabelLineThickness)
              ? 0
        ...
        if (null !== x && "" !== x) {
          ...
          f.measureText();
          l.dataSeries.indexLabelMaxWidth = f.maxWidth;
          if ("stackedarea100" === u) {
            if (
              l.point.x < b.x1 ||
              l.point.x > b.x2 ||
            ...
            if (
              l.dataPoint.x < z.viewportMinimum ||
              l.dataPoint.x > z.viewportMaximum ||
              Math.max.apply(null, l.dataPoint.y) < B.viewportMinimum ||
              Math.min.apply(null, l.dataPoint.y) > B.viewportMaximum
            )
              continue;
          } else if (
            0 <= u.indexOf("line") ||
            ...
            if (
              l.dataPoint.x < z.viewportMinimum ||
              l.dataPoint.x > z.viewportMaximum ||
              l.dataPoint.y < B.viewportMinimum ||
              l.dataPoint.y > B.viewportMaximum
            )
              continue;
          } else if (
            0 <= u.indexOf("column") ||
            "waterfall" === u ||
            ("error" === u && !l.axisSwapped)
          ) {
            if (
              l.dataPoint.x < z.viewportMinimum ||
              l.dataPoint.x > z.viewportMaximum ||
          ...
          e = h = 2;
          "horizontal" === C
            ? ((k = f.width), (t = f.height))
            : ((t = f.width), (k = f.height));
                ...
                0 < ma
                  ...
                  : ((n = l.point.y + h + c),
                    n > g - t - h - c &&
                      ((n =
                        "auto" === s
                          ? Math.min(l.point.y, g) - t - h - c
                          : g - t - h - c),
                      (w = n < l.point.y))))
              : ((e = Math.max(l.bounds.y1, b.y1)),
                (g = Math.min(l.bounds.y2, b.y2)),
                (c =
                  0 <= u.indexOf("range") || "error" === u
                    ? 0 < ma
                      ? Math.max(l.bounds.y1, b.y1) + t / 2 + h
                      : Math.min(l.bounds.y2, b.y2) - t / 2 - h
                    : (Math.max(l.bounds.y1, b.y1) +
                        Math.min(l.bounds.y2, b.y2)) /
                      2),
                0 < ma
                  ? ((n = Math.max(l.point.y, c) - t / 2),
                    n < e &&
                      ("bubble" === u || "scatter" === u) &&
                      (n = Math.max(l.point.y - t - h, b.y1 + h)))
                  : ((n = Math.min(l.point.y, c) - t / 2),
                    n > g - t - h &&
                      ("bubble" === u || "scatter" === u) &&
                      (n = Math.min(l.point.y + h, b.y2 - t - h))),
                (n = Math.min(n, g - t)));
          } else
            0 <= u.indexOf("line") ||
            0 <= u.indexOf("area") ||
                  ...
                  0 > ma
                    ...
                    : ((q = l.point.x + e + c),
                      q > g - k - e - c &&
                        ((q =
                          "auto" === s
                            ? Math.min(l.point.x, g) - k - e - c
                            : g - k - e - c),
                        (w = q < l.point.x))))
                : ((h = Math.max(l.bounds.x1, b.x1)),
                  Math.min(l.bounds.x2, b.x2),
                  (c =
                    0 <= u.indexOf("range") || "error" === u
                      ? 0 > ma
                        ? Math.max(l.bounds.x1, b.x1) + k / 2 + e
                        : Math.min(l.bounds.x2, b.x2) - k / 2 - e
                      : (Math.max(l.bounds.x1, b.x1) +
                          Math.min(l.bounds.x2, b.x2)) /
                        2),
                  (q =
                    0 > ma
                      ? Math.max(l.point.x, c) - k / 2
                      : Math.min(l.point.x, c) - k / 2),
                  (q = Math.max(q, h)));
          "vertical" === C && (n += t);
          f.x = q;
          f.y = n;
          ...
          m &&
            ...
            ((0 > u.indexOf("column") &&
              ...
              !w) &&
            ((d.lineWidth = m),
            (d.strokeStyle = p ? p : "gray"),
            d.setLineDash && d.setLineDash(R(A, m)),
            d.beginPath(),
            d.moveTo(l.point.x, l.point.y),
            0 <= u.indexOf("bar") || ("error" === u && l.axisSwapped)
              ? d.lineTo(
                  q + (0 < l.direction ? 0 : k),
                  n + ("horizontal" === C ? t : -t) / 2
                )
              : 0 <= u.indexOf("column") || ("error" === u && !l.axisSwapped)
              ? d.lineTo(
                  q + k / 2,
                  n +
                    ((0 < l.direction ? t : -t) +
              ...
              : d.lineTo(
                  q + k / 2,
                  n +
                    ((n < l.point.y ? t : -t) + ("horizontal" === C ? t : -t)) /
                      2
                ),
            d.stroke());
        }
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (l = this._indexLabels[a]),
          (f = na("indexLabelBackgroundColor", l.dataPoint, l.dataSeries)),
          (l.dataSeries.indexLabelBackgroundColor = v(f)
            ? r
              ? "transparent"
              : null
            : f);
    ...
    m.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], h, k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          var A = l._colorSet,
            p = (A = l.lineColor = l.options.lineColor
              ? l.options.lineColor
              : A[0]);
          b.strokeStyle = A;
          var m = !0,
          ...
          if (0 < u.length) {
            for (var v = !1, s = 0; s < u.length; s++)
              if (
                ((C = u[s].x.getTime ? u[s].x.getTime() : u[s].x),
                !(
                ...
                if ("number" !== typeof u[s].y)
                  ...
                  s < u.length - 1 &&
                    (p !== (u[s].lineColor || A) ||
                      q !== (u[s].lineDashType || l.lineDashType)) &&
                    (b.stroke(),
                    b.beginPath(),
                    b.moveTo(C, x),
                    (p = u[s].lineColor || A),
                    ...
                    b.setLineDash &&
                      (u[s].lineDashType
                        ? ((q = u[s].lineDashType),
                          b.setLineDash(R(q, l.lineThickness)))
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], h, k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          if (0 < u.length) {
            for (var v = !1, s = 0; s < u.length; s++)
              if (
                ((C = u[s].getTime ? u[s].x.getTime() : u[s].x),
                !(
                  C < a.axisX.dataInfo.viewPortMin ||
                  (C > a.axisX.dataInfo.viewPortMax &&
                    (!l.connectNullData || !v))
                  ...
                  s < u.length - 1 &&
                    ...
                    b.setLineDash &&
                      (u[s].lineDashType
                        ...
                        : ((q = l.lineDashType), b.setLineDash(f))));
                  if (0 < u[s].markerSize || 0 < l.markerSize)
                    (z = l.getMarkerProperties(s, C, x, b)),
                      g.push(z),
                      (B = N(B)),
                      r &&
                        g.push({
        ...
        for (var h = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          if (0 < u.length)
            for (v = !1, m = 0; m < u.length; m++)
              if (
                ((s = u[m].getTime ? u[m].x.getTime() : u[m].x),
                !(
                ...
                if ("number" !== typeof u[m].y)
                  ...
                  m < u.length - 1 &&
                    (p !== (u[m].lineColor || A) ||
                      q !== (u[m].lineDashType || l.lineDashType)) &&
                    ((p = u[m].lineColor || A),
                    (x[x.length - 1].newStrokeStyle = p),
                    c.setLineDash &&
                      (u[m].lineDashType
                        ? ((q = u[m].lineDashType),
    ...
    m.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < A.length)
            for (
              var m = 5 < q && f.bevelEnabled ? !0 : !1, g = 0;
              g < A.length;
              g++
            )
              if (
                (A[g].getTime ? (t = A[g].x.getTime()) : (t = A[g].x),
                !(
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < s.length) {
            ...
            for (l = 0; l < s.length; l++)
              if (
                ((c = s[l].x.getTime ? s[l].x.getTime() : s[l].x),
                !(
                  c < a.axisX.dataInfo.viewPortMin ||
                  c > a.axisX.dataInfo.viewPortMax
                ) && "number" === typeof s[l].y)
                ...
                var x =
                    (u - (a.plotType.plotUnits.length * f) / 2 + a.index * f) <<
                    0,
                  w = (x + f) << 0,
                  z;
                if (
                  ...
                  (t[c] = s[l].y + (t[c] ? t[c] : 0)),
                    (z = a.axisY.convertValueToPixel(t[c])),
                    (q = "undefined" !== typeof h[c] ? h[c] : n),
                    (h[c] = z);
                else if (
                  ((q = a.axisY.convertValueToPixel(s[l].y)), 0 <= s[l].y)
                ) {
                ...
                c = s[l].color
                  ? s[l].color
                  : m._colorSet[l % m._colorSet.length];
                ea(
                  b,
                  x,
                  q,
    ...
    m.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < s.length)
            for (
              var v = 5 < f && p.bevelEnabled ? !0 : !1, l = 0;
              l < s.length;
              l++
            )
              if (
                ...
                if (
                  ...
                  (t[c] = q + ("undefined" !== typeof t[c] ? t[c] : 0)),
                    (z = a.axisY.convertValueToPixel(t[c])),
                    (q = h[c] ? h[c] : n),
                    (h[c] = z);
            ...
            for (l = 0; l < s.length; l++)
              if (
                ...
                if (
                  ...
                  (t[c] = s[l].y + (t[c] ? t[c] : 0)),
                    (u = h[c] ? h[c] : n),
                    (h[c] = z = a.axisY.convertValueToPixel(t[c]));
                else if (
                  ((u = a.axisY.convertValueToPixel(s[l].y)), 0 <= s[l].y)
                ) {
                  var B = g[c] ? g[c] : 0;
                  z = n + B;
                  u += B;
            ...
            for (l = 0; l < s.length; l++)
              if (
                ...
                if (
                  ...
                  (t[c] = x + (t[c] ? t[c] : 0)),
                    (u = h[c] ? h[c] : n),
                    (h[c] = x = a.axisY.convertValueToPixel(t[c]));
    ...
    m.prototype.renderArea = function (a) {
      ...
      function c() {
        B &&
          ...
          g.fill(),
          (g.globalAlpha = 1),
          r && (h.lineTo(s, z), h.lineTo(B.x, z), h.closePath(), h.fill()),
          g.beginPath(),
          g.moveTo(s, v),
          h.beginPath(),
          h.moveTo(s, v),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < m.length) {
            ...
            for (var da = !0; p < m.length; p++)
              if (
                ((x = m[p].x.getTime ? m[p].x.getTime() : m[p].x),
                !(
                ...
                if ("number" !== typeof m[p].y)
                  ...
                  p < m.length - 1 &&
                    (T !== (m[p].lineColor || aa) ||
                      b !== (m[p].lineDashType || A.lineDashType)) &&
                    (c(),
                    (T = m[p].lineColor || aa),
                    (g.strokeStyle = T),
                    g.setLineDash &&
                      (m[p].lineDashType
                        ? ((b = m[p].lineDashType),
                          g.setLineDash(R(b, A.lineThickness)))
                  ...
                  0 !== m[p].markerSize &&
                    (0 < m[p].markerSize || 0 < A.markerSize) &&
                    ((x = A.getMarkerProperties(p, s, v, g)),
                    l.push(x),
                    (Z = N(Z)),
                    r &&
                      l.push({
        ...
        r &&
          ...
          g.clearRect(u.x1, u.y1, u.width, u.height),
          this._eventManager.ghostCtx.restore());
        g.restore();
        return {
          source: e,
      ...
      function d() {
        ...
        if (0 < b.length) {
          ...
          (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum)
            ...
            : 0 > a.axisY.viewportMaximum
            ? (s = h.y1)
            : 0 < a.axisY.viewportMinimum && (s = g.y2);
          v = { x: b[0].x, y: b[0].y };
            ...
            for (p = !1; f < n.length; f++)
              if (
                ...
                if ("number" !== typeof n[f].y)
                  ...
                  f < n.length - 1 &&
                    (B !== (n[f].lineColor || z) ||
                      y !== (n[f].lineDashType || q.lineDashType)) &&
                    ((B = n[f].lineColor || z),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < p.length) {
            ...
            for (; m < p.length; m++)
              if (
                ((x = p[m].x.getTime ? p[m].x.getTime() : p[m].x),
                !(
                  x < a.axisX.dataInfo.viewPortMin ||
                  (x > a.axisX.dataInfo.viewPortMax &&
                    (!A.connectNullData || !b))
                ...
                "number" !== typeof p[m].y
                  ...
                  : ((s = a.axisX.convertValueToPixel(x)),
                    (v = a.axisY.convertValueToPixel(p[m].y)),
                    d || b
                      ? (!d && A.connectNullData
                          ? (g.setLineDash &&
                              (A.options.nullDataLineDashType ||
                              ...
                              (v = b),
                              (B = q),
                              (Y = A.nullDataLineDashType),
                              g.setLineDash(ca)),
                            g.lineTo(s, Z),
                            g.lineTo(s, v),
                            r && (h.lineTo(s, Z), h.lineTo(s, v)))
                          : (g.beginPath(),
                            g.moveTo(s, v),
                            r && (h.beginPath(), h.moveTo(s, v)),
                            (B = { x: s, y: v })),
                    ...
                    m < p.length - 1 &&
                      (T !== (p[m].lineColor || aa) ||
                        Y !== (p[m].lineDashType || A.lineDashType)) &&
                      (c(),
                      (T = p[m].lineColor || aa),
                      (g.strokeStyle = T),
                      g.setLineDash &&
                        (p[m].lineDashType
                          ? ((Y = p[m].lineDashType),
                            g.setLineDash(R(Y, A.lineThickness)))
                          : ((Y = A.lineDashType), g.setLineDash(da)))),
                    (x = A.dataPointIds[m]),
                    ...
                    0 !== p[m].markerSize &&
                      (0 < p[m].markerSize || 0 < A.markerSize) &&
                      ((Z = A.getMarkerProperties(m, s, v, g)),
                      l.push(Z),
                      (x = N(x)),
                      r &&
                        l.push({
    ...
    m.prototype.renderStackedArea = function (a) {
      function d() {
        if (!(1 > l.length)) {
          ...
          c.globalAlpha = 1;
          c.beginPath();
          r && (m.closePath(), m.fill(), m.beginPath());
          l = [];
        }
      }
      var b = a.targetCanvasCtx || this.plotArea.ctx,
            ...
            for (var da = !0, n = 0; n < u.length; n++) {
              ...
              if (
                ...
                if ("number" !== typeof Z.y)
                  ...
                  n < y.length - 1 &&
                    (T !== (y[n].lineColor || aa) ||
                      x !== (y[n].lineDashType || B.lineDashType)) &&
                    (d(),
                    c.beginPath(),
                    c.moveTo(f, A),
                    l.push({ x: f, y: p - oa }),
                    ...
                    c.setLineDash &&
                      (y[n].lineDashType
                        ? ((x = y[n].lineDashType),
                          c.setLineDash(R(x, B.lineThickness)))
                  ...
                  0 <= B.dataPointIndexes[g] &&
                    0 !== Z.markerSize &&
                    (0 < Z.markerSize || 0 < B.markerSize) &&
                    ((oa = B.getMarkerProperties(
                      B.dataPointIndexes[g],
                      f,
                      A,
                      c
                    )),
    ...
    m.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        c.clip();
        r && (x.beginPath(), x.rect(h.x1, h.y1, h.width, h.height), x.clip());
        for (var e = [], w = 0; w < a.dataSeriesIndexes.length; w++) {
          var z = a.dataSeriesIndexes[w],
            B = this.data[z],
            y = B.dataPoints;
            ...
            for (var da = !0, n = 0; n < u.length; n++) {
              ...
              if (
                ...
                if ("number" !== typeof Z.y)
                  ...
                  n < y.length - 1 &&
                    (T !== (y[n].lineColor || aa) ||
                      s !== (y[n].lineDashType || B.lineDashType)) &&
                    (d(),
                    c.beginPath(),
                    c.moveTo(f, m),
                    l.push({ x: f, y: C - la }),
                    ...
                    c.setLineDash &&
                      (y[n].lineDashType
                        ? ((s = y[n].lineDashType),
                          c.setLineDash(R(s, B.lineThickness)))
                        : ((s = B.lineDashType), c.setLineDash(ca))));
                  if (0 <= B.dataPointIndexes[g]) {
                  ...
                  0 <= B.dataPointIndexes[g] &&
                    0 !== Z.markerSize &&
                    (0 < Z.markerSize || 0 < B.markerSize) &&
                    ((la = B.getMarkerProperties(n, f, m, c)),
                    k.push(la),
                    (g = N(G)),
                    r &&
                      k.push({
        ...
        for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          if (0 < u.length) {
            ...
            for (var q = 0, n = 0, e = 0; e < u.length; e++)
              if (
                ((g = u[e].getTime ? (g = u[e].x.getTime()) : (g = u[e].x)),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) && "number" === typeof u[e].y)
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < C.length)
            for (
              var x = 5 < m && s.bevelEnabled ? !0 : !1, k = 0;
              k < C.length;
              k++
            )
              if (
                (C[k].getTime ? (f = C[k].x.getTime()) : (f = C[k].x),
                !(
                  ...
                  !v(C[k].y) &&
                  C[k].y.length &&
                  "number" === typeof C[k].y[0] &&
                  "number" === typeof C[k].y[1] &&
                  "number" === typeof C[k].y[2] &&
                  "number" === typeof C[k].y[3])
              ) {
                ...
                "candlestick" === s.type
                  ? (b.moveTo(t - D, u),
                    b.lineTo(t - D, Math.min(l, n)),
                    b.stroke(),
                    b.moveTo(t - D, Math.max(l, n)),
                    b.lineTo(t - D, q),
                    b.stroke(),
                    ea(
                      b,
                      ...
                      z,
                      Math.max(l, n),
                      C[k].y[0] <= C[k].y[3] ? s.risingColor : g,
                      B,
                      e,
                      x,
                      x,
                    ...
                    r &&
                      ...
                      (c.strokeStyle = e),
                      c.moveTo(t - D, u),
                      c.lineTo(t - D, Math.min(l, n)),
                      c.stroke(),
                      c.moveTo(t - D, Math.max(l, n)),
                      c.lineTo(t - D, q),
                      c.stroke(),
                      ea(
                        c,
                ...
                (C[k].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: C[k],
                    dataSeries: s,
                    point: { x: y + (z - y) / 2, y: a.axisY.reversed ? q : u },
                    direction: 1,
                    bounds: {
                      x1: y,
                      y1: Math.min(u, q),
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var p = !1, p = !!a.axisY.reversed, w = 0;
          ...
          if (0 < x.length)
            for (
              var y = 5 < m && C.bevelEnabled ? !0 : !1, h = 0;
              h < x.length;
              h++
            )
              if (
                ...
                var z = (k - m / 2) << 0,
                  ...
                  Y =
                    "number" === typeof x[h].whiskerThickness
                      ...
                      ? C.whiskerThickness
                      : D,
                  ca = x[h].whiskerDashType
                    ? x[h].whiskerDashType
                    : C.whiskerDashType,
                  da = v(x[h].whiskerLength)
                    ? v(C.options.whiskerLength)
                      ? m
                      : C.whiskerLength
                    : x[h].whiskerLength,
                  da =
                  ...
                  H = x[h].stemDashType ? x[h].stemDashType : C.stemDashType,
                  E = x[h].lineColor
                    ? x[h].lineColor
                    : x[h].color
                    ? C.lineColor
                ...
                0 < la &&
                  ...
                  (b.strokeStyle = oa),
                  (b.lineWidth = la),
                  b.setLineDash && b.setLineDash(R(H, la)),
                  b.moveTo(k - G, l),
                  b.lineTo(k - G, t),
                  b.stroke(),
                  b.moveTo(k - G, q),
                ...
                b.rect(
                  ...
                  Math.min(l, u) - aa,
                  B - z + 2 * aa,
                  Math.max(l, u) - Math.min(l, u) + 2 * aa
                );
                b.stroke();
                b.save();
                0 < F &&
                  (b.beginPath(),
                  (b.globalAlpha = 1),
                  b.setLineDash && b.setLineDash(R(I, F)),
                  (b.strokeStyle = E),
                  (b.lineWidth = F),
                  b.moveTo(z, n - K),
                  b.lineTo(B, n - K),
                ...
                0 < Y &&
                  ...
                  (b.strokeStyle = T),
                  (b.lineWidth = Y),
                  b.moveTo((k - da / 2) << 0, q - Z),
                  b.lineTo((k + da / 2) << 0, q - Z),
                  b.stroke(),
                  b.moveTo((k - da / 2) << 0, t + Z),
                  b.lineTo((k + da / 2) << 0, t + Z),
                  b.stroke());
                b.restore();
                r &&
                  ((e = N(P)),
                  ...
                  0 < la &&
                    (c.moveTo(k - aa - G, l),
                    c.lineTo(k - aa - G, Math.max(t, q)),
                    c.stroke(),
                    c.moveTo(k - aa - G, Math.min(t, q)),
                    c.lineTo(k - aa - G, u),
                    c.stroke()),
                  ea(
                    c,
                ...
                (x[h].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: x[h],
                    dataSeries: C,
                    point: { x: z + (B - z) / 2, y: a.axisY.reversed ? t : q },
                    direction: 1,
                    bounds: {
                      x1: z,
                      y1: Math.min(t, q),
    ...
    m.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < f.length)
            for (
              var m = 5 < l && n.bevelEnabled ? !0 : !1, g = 0;
              g < f.length;
              g++
            )
              if (
                (f[g].getTime ? (t = f[g].x.getTime()) : (t = f[g].x),
                !(
                  t < a.axisX.dataInfo.viewPortMin ||
                  t > a.axisX.dataInfo.viewPortMax
                ) &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var w = 0, s = 0; s < this.data.length; s++)
          !this.data[s].type.match(/(bar|column)/gi) ||
            !this.data[s].visible ||
            (this.data[s].type.match(/(stacked)/gi) && w) ||
            w++;
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (B)
            for (e = y._linkedSeries.id, s = 0; s < e; s++)
              !this.data[s].type.match(/(bar|column)/gi) ||
                !this.data[s].visible ||
                (this.data[s].type.match(/(stacked)/gi) && D) ||
                (this.data[s].type.match(/(range)/gi) && (g = !0), D++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          if (0 < z.length)
            for (var aa = y._colorSet, k = 0; k < z.length; k++) {
              var e = (y.lineColor = y.options.color ? y.options.color : aa[0]),
                T = {
                  color: z[k].whiskerColor
                    ...
                    ? y.whiskerColor
                    : e,
                  thickness: v(z[k].whiskerThickness)
                    ? y.whiskerThickness
                    : z[k].whiskerThickness,
                  dashType: z[k].whiskerDashType
                    ? z[k].whiskerDashType
                    : y.whiskerDashType,
                  length: v(z[k].whiskerLength)
                    ? v(y.options.whiskerLength)
                      ? s
                      : y.options.whiskerLength
                    : z[k].whiskerLength,
                  trimLength: v(z[k].whiskerLength)
                    ? v(y.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              if (
                ...
                c
                  ? ((n = a.axisX.reversed
                      ? (l + ((B ? w : 1) * s) / 2 - (B ? D - 1 : 0) * s) << 0
                      : (l - ((B ? w : 1) * s) / 2 + (B ? D - 1 : 0) * s) << 0),
                    (f = a.axisX.reversed ? (n - s) << 0 : (n + s) << 0))
                  : ((u = a.axisX.reversed
                      ? (t + ((B ? w : 1) * s) / 2 - (B ? D - 1 : 0) * s) << 0
                      : (t - ((B ? w : 1) * s) / 2 + (B ? D - 1 : 0) * s) << 0),
                    (q = a.axisX.reversed ? (u - s) << 0 : (u + s) << 0));
                !c && n > f && ((ca = n), (n = f), (f = ca));
                c && u > q && ((ca = u), (u = q), (q = ca));
                ca = y.dataPointIds[k];
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < m.length) {
            ...
            for (g = 0; g < m.length; g++)
              if (
                (m[g].getTime ? (l = m[g].x.getTime()) : (l = m[g].x),
                !(
                  ...
                  !v(m[g].y) &&
                  m[g].y.length &&
                  "number" === typeof m[g].y[0] &&
                  "number" === typeof m[g].y[1])
              ) {
                ...
                t = a.axisX.reversed
                  ? (t +
                      (a.plotType.totalDataSeries * u) / 2 -
                      (a.previousDataSeriesCount + q) * u) <<
                    0
                  : (t -
                      (a.plotType.totalDataSeries * u) / 2 +
                      (a.previousDataSeriesCount + q) * u) <<
        ...
        for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          if (0 < q.length) {
            ...
            for (var T = !0; f < q.length; f++)
              if (
                ((s = q[f].x.getTime ? q[f].x.getTime() : q[f].x),
                !(
                  s < a.axisX.dataInfo.viewPortMin ||
                  (s > a.axisX.dataInfo.viewPortMax &&
                    (!u.connectNullData || !T))
                ...
                if (
                  ...
                  n || T
                    ? (u.connectNullData && !n
                        ? (c.setLineDash &&
                            (u.options.nullDataLineDashType ||
                              (B === u.lineDashType &&
                                u.lineDashType !== u.nullDataLineDashType)) &&
                            ((t[t.length - 1].newLineDashArray = D),
                            (B = u.nullDataLineDashType),
                            c.setLineDash(y)),
                          c.lineTo(m, p),
                          r && e.lineTo(m, p),
                          t.push({ x: m, y: v }))
                  ...
                  f < q.length - 1 &&
                    (z !== (q[f].lineColor || w) ||
                      B !== (q[f].lineDashType || u.lineDashType)) &&
                    (d(),
                    (z = q[f].lineColor || w),
                    (t[t.length - 1].newStrokeStyle = z),
                    (c.strokeStyle = z),
                    c.setLineDash &&
                      (q[f].lineDashType
                        ? ((B = q[f].lineDashType),
                          (t[t.length - 1].newLineDashArray = R(
                            B,
                            u.lineThickness
                          )),
                  ...
                  if (
                    0 !== q[f].markerSize &&
                    (0 < q[f].markerSize || 0 < u.markerSize)
                  ) {
        ...
        for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          if (0 < u.length) {
            ...
            for (f = !1; q < u.length; q++)
              if (
                ((n = u[q].x.getTime ? u[q].x.getTime() : u[q].x),
                !(
                ...
                if (
                  ...
                  q < u.length - 1 &&
                    (x !== (u[q].lineColor || C) ||
                      y !== (u[q].lineDashType || l.lineDashType)) &&
                    ((x = u[q].lineColor || C),
                    (p[p.length - 1].newStrokeStyle = x),
                    c.setLineDash &&
                      (u[q].lineDashType
                        ? ((y = u[q].lineDashType),
                          (p[p.length - 1].newLineDashArray = R(
                            y,
                            l.lineThickness
                          )))
                        : ((y = l.lineDashType),
                  ...
                  if (
                    0 !== u[q].markerSize &&
                    (0 < u[q].markerSize || 0 < l.markerSize)
                  ) {
        ...
        for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          if (0 < v.length)
            for (
              ...
              if (
                (v[h].getTime ? (u = v[h].x.getTime()) : (u = v[h].x),
                "number" !== typeof v[h].y)
              ) {
                if (0 < h && !y && p.connectNullData)
                  var D =
                    p.options.nullDataLineDashType || !v[h - 1].lineDashType
                ...
                var Y,
                  T = k;
                Y =
                  ("undefined" !== typeof v[h].isIntermediateSum &&
                    !0 === v[h].isIntermediateSum) ||
                  ("undefined" !== typeof v[h].isCumulativeSum &&
                ...
                0 < h &&
                  z &&
                  (!y || p.connectNullData) &&
                  (y && b.setLineDash && b.setLineDash(R(D, s)),
                  b.beginPath(),
                  b.moveTo(z, B - w),
                  b.lineTo(T, Y - w),
                  0 < s && b.stroke(),
    ...
    m.prototype.renderPie = function (a) {
        ...
        if (l && m) {
          for (var a = 0, b = 0, c = 0, e = 0, d = 0; d < m.length; d++) {
            ...
            q = g.indexLabelFormatter
              ...
              : g.indexLabel
              ? t.replaceKeywordsWithValue(g.indexLabel, g, l, d)
              : l.indexLabelFormatter
              ? l.indexLabelFormatter(p)
              : l.indexLabel
              ? t.replaceKeywordsWithValue(l.indexLabel, g, l, d)
              : g.label
              ? g.label
              : "";
            ...
            h.indexLabelLineColor = g.indexLabelLineColor
              ...
              : l.options.indexLabelLineColor
              ? l.options.indexLabelLineColor
              : g.color
              ? g.color
              : l._colorSet[d % l._colorSet.length];
            h.indexLabelLineThickness = v(g.indexLabelLineThickness)
              ? l.indexLabelLineThickness
              : g.indexLabelLineThickness;
            h.indexLabelLineDashType = g.indexLabelLineDashType
              ? g.indexLabelLineDashType
              : l.indexLabelLineDashType;
        ...
        for (b = 0; b < m.length; b++) {
          ...
          if (e > c) {
            ...
            h &&
              ((d = {}),
              (d.dataSeries = l),
              (d.dataPoint = l.dataPoints[b]),
              (d.index = b),
              t.toolTip.highlightObjects([d]));
            ja(
              t.plotArea.ctx,
              f[b].center,
              f[b].radius,
              m[b].color ? m[b].color : l._colorSet[b % l._colorSet.length],
              l.type,
              c,
              e,
              l.fillOpacity,
      ...
      function g(a, b, d) {
        ...
        if (0 <= a && a < m.length) {
          ...
          var q = 0,
            ...
            t = (q = q = 0);
          0 > b
            ? n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 > l &&
          ...
          for (k = 1; k < m.length; k++)
            if (
              ((l = (a - k + f.length) % f.length),
              f[l].hemisphere !== f[a].hemisphere)
            ) {
              l = null;
              break;
            } else if (
              ...
              (0 > c(f[l], f[a]) ||
                ("right" === f[a].hemisphere
                  ? f[l].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y
                  : f[l].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y))
            )
              break;
            else l = null;
            ...
            ? ((k = "right" === n.hemisphere ? t : q),
              ...
              null !== k &&
                ...
                b - t < p &&
                  ((l = -t),
                  (k = g(k, l, d + 1)),
                  +k.toFixed(C) > +l.toFixed(C) &&
                    (h = b > p ? -(b - p) : -(t - (k - l))))))
            : 0 < b &&
              ((k = "right" === n.hemisphere ? q : t),
              (h = b),
              null !== k &&
                ((t = b),
                (b =
          ...
          h &&
            ...
            n.midAngle > Math.PI / 2 - s && n.midAngle < Math.PI / 2 + s
              ? ((l = (a - 1 + f.length) % f.length),
                (l = f[l]),
                (a = f[(a + 1 + f.length) % f.length]),
                "left" === n.hemisphere &&
                "right" === l.hemisphere &&
                b > l.indexLabelTextBlock.x
                  ? (b = l.indexLabelTextBlock.x - 15)
                  : "right" === n.hemisphere &&
                    "left" === a.hemisphere &&
      ...
      function h() {
        ...
        for (
          ...
          if (
            l.radius ||
            (!l.radius &&
              "undefined" !== typeof l.innerRadius &&
              null !== l.innerRadius &&
              B - d <= D)
          )
            h = !1;
          ...
          if ("inside" !== l.indexLabelPlacement) {
              ...
              if (null !== z) {
                ...
                if (0 > y) {
                  for (var E = (v = 0), F = 0; F < m.length; F++)
                    F !== a &&
                      f[F].hemisphere === k.hemisphere &&
                      (f[F].indexLabelTextBlock.y < k.indexLabelTextBlock.y
                        ? v++
                        : E++);
                  v = (y / (v + E || 1)) * E;
                  var E = -1 * (y - v),
            ...
            for (a = 0; a < m.length; a++)
              (k = f[a]),
                (r = "pie" === l.type ? 0.7 * B : 0.8 * B),
                (z = x.x + r * Math.cos(k.midAngle)),
                (v = x.y + r * Math.sin(k.midAngle)),
                (k.indexLabelTextBlock.x = z),
                (k.indexLabelTextBlock.y = v);
          for (a = 0; a < m.length; a++)
            if (
              ((k = f[a]),
              ...
              (z = z = 0),
                ...
                0 < z &&
                  (!h &&
                    ...
                    0.3 * k.indexLabelTextBlock.maxWidth > v
                      ? (k.indexLabelText = "")
                      : (k.indexLabelTextBlock.maxWidth = 0.85 * v),
                    0.3 * k.indexLabelTextBlock.maxWidth < v &&
                      (k.indexLabelTextBlock.x -=
              ...
              if (((g = !1), (s = f[k]), s.indexLabelText)) {
                ...
                if (null !== h) {
                  ...
                  n
                    ? (0 > a && (a = k),
                      h !== a && ((b = h), (d += -y)),
                      0 === k % Math.max(m.length / 10, 3) && (g = !0))
                    : (g = !0);
                  g &&
                    0 < d &&
                    0 <= a &&
      ...
      function k() {
        ...
        t.legend &&
          ...
          (t.legend.setLayout(), t.legend.render());
      }
      var t = this;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var z = 0; z < m.length; z++)
          (y += Math.abs(m[z].y)),
            !a &&
              "undefined" !== typeof m[z].indexLabel &&
              null !== m[z].indexLabel &&
              0 < m[z].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof m[z].label &&
              null !== m[z].label &&
              0 < m[z].label.toString().length &&
              (a = !0);
        if (0 !== y) {
          a =
            a ||
            ("undefined" !== typeof l.indexLabel &&
              null !== l.indexLabel &&
              0 < l.indexLabel.toString().length);
          var B =
            "inside" !== l.indexLabelPlacement && a
              ? (0.75 * Math.min(n.width, n.height)) / 2
              : (0.92 * Math.min(n.width, n.height)) / 2;
          l.radius && (B = I(l.radius, B));
          var D =
            "undefined" !== typeof l.innerRadius && null !== l.innerRadius
              ? I(l.innerRadius, B)
              : 0.7 * B;
          l.radius = B;
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              for (b = 0; b < m.length; b++) {
                ...
                var g = m[b].color
                  ? m[b].color
                  : l._colorSet[b % l._colorSet.length];
                e > c &&
                  ja(
                    t.plotArea.ctx,
                    f[b].center,
    ...
    m.prototype.renderFunnel = function (a) {
      ...
      function b() {
        ...
        if (0 === g) return -1;
        for (
          var l = (e[0] = 0), h = 0, n, q, b = b - a, l = !1, k = 0;
          k < C.length;
          k++
        )
          (a = (Math.abs(C[k].y) * f) / g),
            l
              ? (n = 0 == Number(c.toFixed(3)) ? 0 : a / c)
              : ((q = ba * ba * b * b - 4 * Math.abs(ba) * a),
                0 > q
                  ? ((q = c),
                    (l = ((b + q) * (d - h)) / 2),
                    (a -= l),
        ...
        if (s && C) {
          ...
          for (var w = 0, B = C.length - 1; w < C.length || 0 <= B; w++, B--) {
            ...
            a = b.color
              ? b.color
              : s.reversed
              ? s._colorSet[(C.length - 1 - w) % s._colorSet.length]
              : s._colorSet[w % s._colorSet.length];
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? y.replaceKeywordsWithValue(b.indexLabel, b, s, w)
              : s.indexLabelFormatter
              ? s.indexLabelFormatter(z)
              : s.indexLabel
              ? y.replaceKeywordsWithValue(s.indexLabel, b, s, w)
              : b.label
              ? b.label
              : "";
            0 >= n && (n = 0);
      ...
      function e() {
        ...
        for (
          var g,
            k = L - V - S / 2,
            k = s.options.indexLabelMaxWidth
              ? s.indexLabelMaxWidth > k
                ? k
                : s.indexLabelMaxWidth
              : k,
            h = J.length - 1;
      ...
      function h() {
        ...
        function b() {
          ...
          for (var k, l = 1; l < h; l++) {
            ...
            for (var t = J.length - 1; 0 <= t; t--)
              !J[t].isDirty &&
                J[t].textBlock.y < e &&
                J[t].textBlock.y + J[t].height > e &&
                ((k = n(t)),
                !(k >= J.length - 1) &&
                  J[t].textBlock.y + J[t].height + ga > J[k].textBlock.y &&
                  (J[t].textBlock.y =
                    J[t].textBlock.y + J[t].height - e > e - J[t].textBlock.y
                      ? e + 1
                      : e - J[t].height - 1));
          }
        ...
        for (var d, e, f, g, h, l, m = 1, t = 0; t < 2 * m; t++) {
          for (
            ...
            (f = J[p]),
            (g = f.textBlock),
            (l = (h = n(p) < P.length ? J[n(p)] : null) ? h.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty &&
              h &&
              e + d + ga > +l.y.toFixed(6) &&
              ((d = g.y + d + ga - l.y),
              (e = a(p, -d)),
              e < d && (0 < e && (d -= e), (e = a(n(p), d)), e != d)));
            p--
          );
          b();
        }
      ...
      function k(a, b) {
        return (
          (b < P.length ? J[b].textBlock.y : s.reversed ? pa + D : wa + D) -
          (0 > a
            ? s.reversed
              ? wa - D
              : pa - D
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          ...
          if (
            ...
            !F &&
              ...
              (F = !0),
            (!F && "function" === typeof s.indexLabelFormatter) ||
        ...
        ("inside" !== s.indexLabelPlacement && F) ||
          (z = (x.width - 0.75 * E) / 2);
        var I = x.x1 + z,
          L = x.x2 - z,
          O = x.y1 + D,
        ...
        if (0 != s.length && s.dataPoints && s.visible && 0 !== C.length) {
          ...
          var S = (30 * (L - a)) / 100;
          "funnel" === s.type
            ? ((N = v(s.options.neckHeight) ? 0.35 * H : s.neckHeight),
              (G = v(s.options.neckWidth) ? 0.25 * a : s.neckWidth),
              "string" === typeof N && N.match(/%$/)
                ? ((N = parseInt(N)), (N = (N * H) / 100))
                : (N = parseInt(N)),
              ...
              G > a ? (G = a - 0.5) : 0 >= G && (G = 0))
            : "pyramid" === s.type &&
              ((G = N = 0), (s.reversed = s.reversed ? !1 : !0));
          var z = I + a / 2,
            $ = I,
            V = I + a,
            pa = s.reversed ? Z : O,
          ...
          var z = [],
            ...
            ha = -ba,
            I =
              "area" === (s.valueRepresents ? s.valueRepresents : "height")
                ? b()
                : d();
          if (-1 !== I) {
            if (s.reversed)
            ...
            if (s.reversed)
              for (G = 0; G < I.length; G++)
                E[G] < Da
                  ? (a.push(K), z.push(ea), (fa = G))
                  : (a.push((E[G] - pa + ba * $) / ba),
                    z.push((E[G] - pa + ha * V) / ha));
            else
              for (G = 0; G < I.length; G++)
                E[G] < Da
                  ? (a.push((E[G] - pa + ba * $) / ba),
            ...
            for (G = 0; G < I.length - 1; G++)
              (X = s.reversed
                ? C[C.length - 1 - G].color
                  ? C[C.length - 1 - G].color
                  : s._colorSet[(C.length - 1 - G) % s._colorSet.length]
                : C[G].color
                ? C[G].color
                : s._colorSet[G % s._colorSet.length]),
                G === fa
                  ? P.push({
                      x1: a[G],
                      y1: E[G],
            ...
            for (G = 0; G < C.length; G++)
              C[G].exploded &&
                ((I = !0), s.reversed ? W.push(C.length - 1 - G) : W.push(G));
            ...
            if (
              F &&
              s.visible &&
              (c(), g(), e(), "inside" !== s.indexLabelPlacement)
            ) {
              h();
              for (G = 0; G < C.length; G++)
                J[G].isDirty ||
              ...
              for (G = 0; G < P.length; G++)
                (P[G].x1 += B),
                  ...
                  (P[G].x3 += B),
                  (P[G].x4 += B),
                  P[G].x5 && ((P[G].x5 += B), (P[G].x6 += B)),
                  (J[G].textBlock.x += B);
            }
            for (G = 0; G < P.length; G++)
              (B = P[G]), ra(Q, B, s.fillOpacity), ia.push(B.y1);
            w(Q);
            F &&
              s.visible &&
              ("inside" === s.indexLabelPlacement || y.animationEnabled || p(Q),
              y.animationEnabled || A());
            if (!F)
              for (G = 0; G < C.length; G++)
                (B = s.dataPointIds[G]),
                  (a = {
    ...
    F.prototype.setLayout = function () {
      var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        k = (this.markerMargin =
          ...
          !v(this.chart.options.legend.markerMargin)
            ...
            var n = (q.legendMarkerType = q.legendMarkerType
                ...
                ? "error" === q.type && q._linkedSeries
                  ? q._linkedSeries.legendMarkerType
                    ? q._linkedSeries.legendMarkerType
                    : H.getDefaultLegendMarker(q._linkedSeries.type)
              ...
              r =
                ...
                ("line" !== q.type &&
                  ...
                  : 0,
              w = q.legendMarkerBorderColor
                ? q.legendMarkerBorderColor
                : q.markerBorderColor,
              s = q.legendMarkerBorderThickness
            ...
            for (var y = 0; y < q.dataPoints.length; y++) {
              var x = q.dataPoints[y],
                ...
                w = x.legendMarkerBorderColor
                  ...
                  ? x.markerBorderColor
                  : q.markerBorderColor,
                s = x.legendMarkerBorderThickness
      ...
      if (0 < t.length) {
            ...
            if ("horizontal" === this.orientation) {
              ...
              (n.textBlock = new ka(this.ctx, {
                ...
                this.height < h - this.lineHeight
                  ? ((q = { items: [], width: 0 }), l.push(q))
                  : ((q = l[y]), (y = (y + 1) % l.length)),
        ...
        this.itemWidth = p;
        this.height =
          !1 === this.itemWrap ? l.length * this.lineHeight : this.height + f;
      ...
      for (var k = 0, m = 0; m < h.length; m++) {
        for (var l = h[m], p = 0, q = 0; q < l.items.length; q++) {
          ...
          this.ghostCtx.fillRect(
            ...
            n.textBlock.x + n.textBlock.width - v,
            n.textBlock.height
          );
            ...
            switch (this.type) {
              ...
              case "doughnut":
                ...
                r < n.radius &&
                  ...
                  0 === w && 1 < n.endAngle && (w = 360),
                  v >= w && 0 !== f.y && ((w += 360), r < v && (r += 360)),
                  r > v &&
                    r < w &&
                    (c.push({
                      dataPoint: f,
    ...
    y.prototype.createLabels = function () {
      var a,
        ...
        k = 0,
        m,
        l = 0.6 * this.chart.height,
        p;
      a = !1;
      var q = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [],
        n = q.length
          ? v(this.scaleBreaks.firstBreakIndex)
            ? 0
      ...
      if (this.labelAutoFit || this.options.labelAutoFit)
        if (
          ...
          if (
            ...
            for (
              ...
              if (!this._labels[b].breaksLabelType) {
                ...
                if (
                      ...
                      if (!v(this.options.labelMaxWidth))
                        ...
                        if (
                          ...
                          c - 2 * g > q &&
                            ...
                            c >= 2 * g && c < 2.2 * g
                              ? ((this.sessionVariables.labelMaxWidth = g),
                                v(this.options.labelFontSize) &&
                                  12 < f &&
                                  ((f = Math.floor((12 / 13) * f)),
                                  a.measureText()),
                                (this.sessionVariables.labelFontSize = v(
                  ...
                  v(this.options.labelWrap))
                    ? v(this.options.labelWrap) &&
                      (this.labelWrap && !v(this.options.labelMaxWidth)
                        ? ((this.sessionVariables.labelWrap = this.labelWrap),
            ...
            for (b = 0; b < this._labels.length; b++)
              (a = this._labels[b].textBlock),
                (a.maxWidth = this.labelMaxWidth = v(this.options.labelMaxWidth)
                  ? this.sessionVariables.labelMaxWidth
                  : this.options.labelMaxWidth),
                (a.fontSize = this.labelFontSize = v(this.options.labelFontSize)
                  ? this.sessionVariables.labelFontSize
                  : this.options.labelFontSize),
                (a.angle = this.labelAngle = v(this.options.labelAngle)
                  ? this.sessionVariables.labelAngle
                  : this.labelAngle),
                (a.wrap = this.labelWrap = v(this.options.labelWrap)
          ...
          if (
            ...
            this.sessionVariables.labelMaxWidth = g;
            this.sessionVariables.labelMaxHeight = h;
            this.sessionVariables.labelAngle = v(
              this.sessionVariables.labelAngle
            )
              ? 0
              : this.sessionVariables.labelAngle;
      ...
      for (b = 0; b < this.stripLines.length; b++) {
        ...
        if ("outside" === g.labelPlacement) {
          ...
          (h =
            ...
            (y =
              v(g.options.labelWrap) || g.labelWrap
                ? "bottom" === this._position || "top" === this._position
                  ? (0.8 * this.chart.width) >> 0
                  : (0.8 * this.chart.height) >> 0
                : 1.5 * this.labelFontSize),
            v(g.labelBackgroundColor) &&
              (v(g.startValue) && 0 !== g.startValue
    ...
    y.setLayout = function (a, d, b, c, e, g) {
      ...
      for (f = 0; f < n.length; f++)
        if (n[f] && n[f].scaleBreaks && n[f].scaleBreaks._appliedBreaks.length)
          for (
            var r = n[f].scaleBreaks._appliedBreaks, w = 0;
            w < r.length && !(r[w].startValue > n[f].viewportMaximum);
            w++
          )
            r[w].endValue < n[f].viewportMinimum ||
              (v(n[f].scaleBreaks.firstBreakIndex) &&
                (n[f].scaleBreaks.firstBreakIndex = w),
              r[w].startValue >= n[f].viewPortMinimum &&
                (n[f].scaleBreaks.lastBreakIndex = w));
      for (
        var y = (w = 0),
          s = 0,
          C = 0,
          ...
          if (a && 0 < a.length)
            for (C = [], f = V = 0; f < a.length; f++)
              a[f] && (a[f].lineCoordinates = {}),
                (a[f].lineCoordinates.width = Math.abs(m - h)),
                a[f].title &&
          ...
          if (d && 0 < d.length)
            for (x = [], f = X = 0; f < d.length; f++)
              d[f] && (d[f].lineCoordinates = {}),
                (d[f].lineCoordinates.width = Math.abs(m - h)),
                d[f].title &&
              ...
              a[f] &&
                ...
                a[f]._labels &&
                  ...
                  (y =
                    ...
                    (l.textBlock.height - k.textBlock.fontSize / 2) *
                ...
                (k = Math.round(g.y2 - V - e + G)),
                (l = Math.round(g.y2)),
                (a[f].lineCoordinates.x2 = m),
                (a[f].lineCoordinates.width = m - h),
          ...
          if (d && 0 < d.length)
            for (f = 0; f < d.length; f++)
              (d[f].lineCoordinates.x1 = Math.round(g.x1 + P + K)),
                ...
                (k = Math.round(g.y1)),
                (l = Math.round(g.y2 + d[f].margin)),
                (d[f].lineCoordinates.y1 = k + X + W - R),
              ...
              a[f] &&
                ...
                a[f]._labels &&
                  ...
                  (E = a[f].logarithmic
                    ...
                    : (0 < h
                        ? h * Math.abs(a[f].conversionParameters.pixelPerUnit)
                        : 0) + a[f].lineCoordinates.x1)));
          if (d && 0 < d.length)
            for (f = 0; f < d.length; f++)
              d[f].calculateValueToPixelConversionParameters(),
                ...
                d[f]._labels &&
                  ...
                  (E = d[f].logarithmic
                    ...
                    : (0 < h
                        ? h * Math.abs(d[f].conversionParameters.pixelPerUnit)
                        : 0) + d[f].lineCoordinates.x1));
          for (f = 0; f < n.length; f++)
            "axisY" === n[f].type &&
        ...
        for (N = []; 4 > w; ) {
          ...
          if (b && 0 < b.length)
            for (f = 0; f < b.length; f++)
              (b[f].lineCoordinates = {}),
                ...
                (b[f].lineCoordinates.x2 = m),
                (b[f].lineCoordinates.width = Math.abs(m - h)),
                b[f].title &&
                  (b[f]._titleTextBlock.maxWidth =
                    0 < b[f].titleMaxWidth &&
          ...
          if (c && 0 < c.length)
            for (f = 0; f < c.length; f++)
              (c[f].lineCoordinates = {}),
                ...
                (c[f].lineCoordinates.x2 = m),
                (c[f].lineCoordinates.width = Math.abs(m - h)),
                c[f].title &&
                  (c[f]._titleTextBlock.maxWidth =
                    0 < c[f].titleMaxWidth &&
          ...
          if (b && 0 < b.length)
            for (f = b.length - 1; 0 <= f; f--)
              (k = Math.round(g.y2)),
                ...
                (b[f].lineCoordinates.y1 = k - (q[f] + b[f].margin + X)),
                (b[f].lineCoordinates.y2 = k - (q[f] + b[f].margin + X)),
                (b[f].bounds = {
                  x1: h,
          ...
          if (c && 0 < c.length)
            for (f = c.length - 1; 0 <= f; f--)
              c[f] &&
                ((k = Math.round(g.y1)),
                (l = Math.round(g.y1 + (B[f] + c[f].margin + G))),
                (c[f].lineCoordinates.y1 = l),
                (c[f].lineCoordinates.y2 = l),
                (c[f].bounds = {
                  x1: h,
                  y1: k + (c[f].margin + G),
                  x2: m,
            ...
            for (f = 0; f < a.length; f++) {
              ...
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] &&
                    c[K].labelAutoFit &&
                    ((m = c[K].lineCoordinates.x1), (h = m - U));
              a[f].lineCoordinates = {
                x1: m - O,
                y1: k,
                x2: m - O,
            ...
            for (f = 0; f < d.length; f++) {
              ...
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] &&
                    c[K].labelAutoFit &&
                    ((m = c[K].lineCoordinates.x2), (h = m - V));
              d[f].lineCoordinates = {
                x1: m + Q,
                y1: k,
                x2: m + Q,
    ...
    y.render = function (a, d, b, c, e) {
      ...
      if (c && 0 < c.length)
        for (k = 0; k < c.length; k++) c[k].renderLabelsTicksAndTitle();
      g.preparePlotArea();
      g = g.plotArea;
      e.save();
      e.beginPath();
      ...
      if (a && 0 < a.length)
        for (k = 0; k < a.length; k++)
          a[k].renderGrid(),
            r && (a[k].createMask(), a[k].renderBreaksBackground());
      if (d && 0 < d.length)
        for (k = 0; k < d.length; k++)
          d[k].renderGrid(),
            r && (d[k].createMask(), d[k].renderBreaksBackground());
      if (b && 0 < b.length)
        for (k = 0; k < b.length; k++)
          b[k].renderGrid(),
            r && (b[k].createMask(), b[k].renderBreaksBackground());
      if (c && 0 < c.length)
        for (k = 0; k < c.length; k++)
          c[k].renderGrid(),
            r && (c[k].createMask(), c[k].renderBreaksBackground());
      if (a && 0 < a.length)
          ...
          b =
            ...
            a /
              (this.logarithmic
                ...
                : this.conversionParameters.maximum -
                  this.conversionParameters.minimum),
          c = this.scaleBreaks && !v(this.scaleBreaks.options.spacing),
          e,
          g = 0;
        g < d.length;
        g++
      )
        (e = c || !v(d[g].options.spacing)),
          (d[g].spacing =
          ...
          if (this.scaleBreaks && !v(this.scaleBreaks.firstBreakIndex))
            if (v(this.scaleBreaks.lastBreakIndex))
              ...
              for (
                ...
                d.moveTo(e, h),
                  d.lineTo(
                    this.scaleBreaks._appliedBreaks[k].startPixel + b,
                    h
                  ),
            ...
            (c / 1 <= a
              ...
              : ((this.interval =
                  c / (1 * S.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(
                        y.getNiceNumber(c / (a - 1), !0) / S.yearDuration
                      )),
    ...
    y.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      h = Math.pow(
        this.logarithmBase,
        y.getNiceNumber(Math.abs(Math.log(h) / d), !1)
      );
      this.options && 0 < this.options.interval
          ...
          if (
            ...
            "top" === this.scaleBreaks.parent._position
              ? ((e = this.chart.plotArea.y1),
                (k = (this.chart.plotArea.y2 + q / 2 + 0.5) << 0))
    ...
    fa.prototype.render = function (a, d) {
            ...
            l =
              "xySwapped" === this.chart.plotInfo.axisPlacement
                ...
                : Math.floor(
                  ...
                  (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0);
          this.valueFormatString = y.generateValueFormatString(
            this.parent.range,
            l
          );
        }
      ...
      p.lineWidth = l;
      p.save();
      this.labelFontSize = v(this.options.labelFontSize)
        ? this.parent.labelFontSize
        : this.labelFontSize;
      if ("left" === this.parent._position || "right" === this.parent._position)
        (this.labelMaxWidth = v(this.options.labelMaxWidth)
          ? this.parent.bounds.x2 - this.parent.bounds.x1
          : this.labelMaxWidth),
          (this.labelMaxHeight =
            v(this.options.labelWrap) || this.labelWrap
              ? 3 * this.chart.height
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if (
            ...
            for (
              var f = Math.abs(
                  a - this.parent.convertValueToPixel(h[r].dataPoint.y[0])
                ),
                w = 0,
                n = 0;
              n < h.length;
            ...
            for (
              ...
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                ...
                (D += h[n].dataPoint.y),
                  (w = Math.abs(a - this.parent.convertValueToPixel(D))),
                  w < f && ((f = w), (r = n));
            ...
            for (
              ...
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                ...
                (D += h[n].dataPoint.y),
                  (s = h[n].dataPoint.x.getTime
                    ? h[n].dataPoint.x.getTime()
                    : h[n].dataPoint.x),
                  (s = 100 * (D / h[n].dataSeries.plotUnit.dataPointYSums[s])),
                  (w = Math.abs(a - this.parent.convertValueToPixel(s))),
                  w < f && ((f = w), (r = n));
          else
            for (
              f = Math.abs(
          ...
          if (
            ...
            if (
              ...
              h =
                1 === p.lineWidth % 2
                  ? (this.parent.convertValueToPixel(s) << 0) + 0.5
                  : this.parent.convertValueToPixel(s) << 0;
              k.text = this.labelFormatter
                ? this.labelFormatter({
                    chart: this.chart,
                    axis: this.parent.options,
                ...
                : v(this.options.label)
                ? ba(s, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
            } else
              (h =
                1 === p.lineWidth % 2
          ...
          if (
            ...
            for (
              f = Math.abs(
                d - this.parent.convertValueToPixel(h[0].dataPoint.y[0])
              ),
                n = w = 0;
              n < h.length;
              n++
              ...
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                for (m = 0; m < h[n].dataPoint.y.length; m++)
                  (w = Math.abs(
                    d - this.parent.convertValueToPixel(h[n].dataPoint.y[m])
                  )),
                    w < f && ((f = w), (r = n));
              else
                (w = Math.abs(
                  d - this.parent.convertValueToPixel(h[n].dataPoint.y)
                )),
                  w < f && ((f = w), (r = n));
          else if (
            ...
            for (
              f = Math.abs(
                d - this.parent.convertValueToPixel(h[0].dataPoint.y)
              ),
                n = D = w = 0;
              n < h.length;
              n++
              ...
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                ...
                (D += h[n].dataPoint.y),
                  (w = Math.abs(d - this.parent.convertValueToPixel(D))),
                  w < f && ((f = w), (r = n));
          else if (
              ...
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                ...
                (D += h[n].dataPoint.y),
                  (s = h[n].dataPoint.x.getTime
                    ...
                    : h[n].dataPoint.x),
                  (s = 100 * (D / h[n].dataSeries.plotUnit.dataPointYSums[s])),
                  (w = Math.abs(d - this.parent.convertValueToPixel(s))),
                  w < f && ((f = w), (r = n));
          else
            for (
              f = Math.abs(
          ...
          if (
            ...
            for (n = w = 0; n < m.dataPoint.y.length; n++)
              (w = Math.abs(
                d - this.parent.convertValueToPixel(m.dataPoint.y[n])
              )),
                w < f && ((f = w), (b = n));
            h =
              1 === p.lineWidth % 2
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var m = 0; m < this.chart.axisX.length; m++) {
                for (
                  var h = this.chart.axisX[m].convertPixelToValue({ y: d }),
                    l = null,
                    c = 0;
                  c < this.chart.axisX[m].dataSeries.length;
                  c++
                )
                  (l = this.chart.axisX[m].dataSeries[c].getDataPointAtX(
                    h,
                    b
                  )) &&
                    0 <= l.index &&
                    ((l.dataSeries = this.chart.axisX[m].dataSeries[c]),
            ...
            if (this.chart.axisX2)
              for (m = 0; m < this.chart.axisX2.length; m++) {
                ...
                for (c = 0; c < this.chart.axisX2[m].dataSeries.length; c++)
                  (l = this.chart.axisX2[m].dataSeries[c].getDataPointAtX(
                    h,
                    b
                  )) &&
                    0 <= l.index &&
                    ((l.dataSeries = this.chart.axisX2[m].dataSeries[c]),
                    null !== l.dataPoint.y && k.push(l));
                l = null;
              }
          } else {
          ...
          if ((l = this.chart.getDataPointAtXY(a, d, b)))
            (this.currentDataPointIndex = l.dataPointIndex),
              (this.currentSeriesIndex = l.dataSeries.index);
          else if (r)
            if (
              ((l = ab(a, d, this.chart._eventManager.ghostCtx)),
              0 < l &&
                "undefined" !== typeof this.chart._eventManager.objectMap[l])
            ) {
              ...
              this.currentDataPointIndex =
                0 <= l.dataPointIndex ? l.dataPointIndex : -1;
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (0 <= this.currentDataPointIndex)
              (c = e.dataPoints[this.currentDataPointIndex]),
                (l.dataSeries = e),
                (l.dataPoint = c),
                (l.index = this.currentDataPointIndex),
                (l.distance = Math.abs(c.x - h)),
                "waterfall" === e.type &&
              ...
              if (l.dataSeries.axisY)
                if (0 < l.dataPoint.y.length) {
                  for (c = b = 0; c < l.dataPoint.y.length; c++)
                    l.dataPoint.y[c] < l.dataSeries.axisY.viewportMinimum
                      ? b--
                      : l.dataPoint.y[c] > l.dataSeries.axisY.viewportMaximum &&
                        b++;
                  ...
                  "column" === e.type || "bar" === e.type
                    ? 0 > l.dataPoint.y
                      ? 0 > l.dataSeries.axisY.viewportMinimum &&
                        l.dataSeries.axisY.viewportMaximum >= l.dataPoint.y &&
                        g.push(l)
                      : l.dataSeries.axisY.viewportMinimum <= l.dataPoint.y &&
                        0 <= l.dataSeries.axisY.viewportMaximum &&
                        g.push(l)
                    : "bubble" === e.type
                    ? ((b =
                        this.chart._eventManager.objectMap[
                          e.dataPointIds[l.index]
                        ].size / 2),
                      l.dataPoint.y >= l.dataSeries.axisY.viewportMinimum - b &&
                        l.dataPoint.y <=
                          l.dataSeries.axisY.viewportMaximum + b &&
                        g.push(l))
                    : "waterfall" === e.type
                    ? ((b = 0),
                      l.cumulativeSumYStartValue <
                      l.dataSeries.axisY.viewportMinimum
                        ? b--
                        : l.cumulativeSumYStartValue >
                            l.dataSeries.axisY.viewportMaximum && b++,
                      l.cumulativeSum < l.dataSeries.axisY.viewportMinimum
                        ? b--
                        : l.cumulativeSum >
                            l.dataSeries.axisY.viewportMaximum && b++,
                      2 > b && -2 < b && g.push(l))
                    : (0 <= l.dataSeries.type.indexOf("100") ||
                        "stackedColumn" === e.type ||
                        "stackedBar" === e.type ||
                        (l.dataPoint.y >= l.dataSeries.axisY.viewportMinimum &&
                          l.dataPoint.y <=
    ...
    $.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries;
      for (
        var d = null, b = null, c = null, e = 0, g = "", h = !0, k = 0;
        k < a.length;
        k++
      )
                ...
                : this.chart.axisX2 &&
                  ...
                  (l +=
                    "undefined" !== typeof this.chart.axisX2[0].labels[c.x]
                      ...
                      : "{x}"),
              (l += "</br>"),
              (l = this.chart.replaceKeywordsWithValue(l, c, b, e))),
